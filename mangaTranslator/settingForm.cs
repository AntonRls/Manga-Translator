    ...
    public partial class settingForm : Form
    {
        ...
        private void settingForm_Load(object sender, EventArgs e)
        {
            ...
            if (Properties.Settings.Default.languageProgramm == "en")
            {
                ...
                textBox4.Text = "Select the language to translate and write it down in the following format: \"ru\", where \"ru\" is a two-letter country code";
                checkBox1.Text = "Scanning text from an image";
            ...
            else if (Properties.Settings.Default.languageProgramm == "ru")
            {
                ...
                textBox4.Text = "Выберите язык для перевода и запишите его в следующем формате: \"ru\", где \"ru\" - двухбуквенный код страны";
                checkBox1.Text = "Сканирование текста с картинки";
                checkBox2.Text = "Перевод текста";
                groupBox1.Text = "Сервис для перевода";
                groupBox2.Text = "Язык интерфейса";
