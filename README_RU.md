...
Используя Manga Translator, вы можете в два клика переводить мангу. <a href="https://github.com/AntonRls/Manga-Translator/releases/download/Realesev1.5/MangaTranslator.zip">Скачать программу</a>
<hr/>
...
<li>Поддержка DeepL
<li>Поддержка Google Translator
<li>Поддержка OpenAI (ChatGPT)
</ul>
